...
import 'package:qr_code_test_site/inspect_role_screens/qr_screen_inspect/inspec_qr_scr_inner/qr_screen_inspect_inner_acts.dart';
...
class InspectQrScreen extends StatefulWidget {
  const InspectQrScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _InspectQrScreenState();
}

class _InspectQrScreenState extends State<InspectQrScreen> {
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const QrScreenInspectActsHistory(),
                        ));
                      },
                      child: Material(
                        borderRadius: BorderRadius.circular(20),
...
//     // Здесь вы можете реализовать свою проверку формата.
//     // Например, проверка наличия "AA" в начале и "I9S4M58" в конце строки.
//     // Вам может потребоваться более сложная логика в зависимости от вашего формата.
//     return code.startsWith("AA") && code.endsWith("I9S4M58");
//   }
